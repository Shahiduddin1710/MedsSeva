...
import {
  ...
  sendForgotPasswordOtpMobile, verifyForgotPasswordOtpMobile, resetPasswordMobile,
...
router.post('/mobile/forgot-password', sendForgotPasswordOtpMobile);
router.post('/mobile/verify-reset-otp', verifyForgotPasswordOtpMobile);
